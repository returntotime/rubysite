...
ActiveRecord::Schema.define(version: 20160502095749) do
  ...
  create_table "spree_assets", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "ls_id",                   limit: 4
    t.integer  "ls_matrix_id",            limit: 4
  end
  ...
  create_table "spree_blog_entries", force: :cascade do |t|
    ...
    t.boolean  "use_large_banner",               default: true
  end
  ...
  create_table "spree_brands", force: :cascade do |t|
    ...
    t.string   "logo_header_file_name",    limit: 255
    t.string   "logo_header_content_type", limit: 255
    t.integer  "logo_header_file_size",    limit: 4
    t.datetime "logo_header_updated_at"
    t.integer  "position",                 limit: 4
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.integer  "local_merchant_id",    limit: 4
  end
  ...
  create_table "spree_option_types", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.boolean  "from_ls",                  default: false
  end
  ...
  create_table "spree_pages", force: :cascade do |t|
    ...
    t.boolean  "active_our_team_section",                default: false
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.text     "ls_long_description",  limit: 4294967295
    t.text     "ls_short_description", limit: 4294967295
    t.decimal  "ls_width",                                precision: 8, scale: 2
    t.decimal  "ls_height",                               precision: 8, scale: 2
    t.decimal  "ls_weight",                               precision: 8, scale: 2
    t.decimal  "ls_length",                               precision: 8, scale: 2
    t.boolean  "in_new_arrival",                                                  default: false
    t.boolean  "in_in_this_look",                                                 default: false
    t.boolean  "in_popular_weekly",                                               default: false
    t.boolean  "no_sale",                                                         default: false
    t.string   "tax_cloud_tic",        limit: 255
  end
  ...
  create_table "spree_slide_locations", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "use_speed",                default: false
    t.string   "presentation", limit: 255
    t.boolean  "fullwidth",                default: true
    t.integer  "height",       limit: 4
    t.integer  "width",        limit: 4
  end
  ...
  create_table "spree_socials", force: :cascade do |t|
    t.string   "name",              limit: 255
    t.string   "url",               limit: 255
  ...
  create_table "spree_stock_locations", force: :cascade do |t|
    ...
    t.string   "admin_name",             limit: 255
    t.boolean  "hide_out_of_stock",                  default: false
  end
  ...
  create_table "spree_stores", force: :cascade do |t|
    ...
    t.datetime "created_at",                                             null: false
    t.datetime "updated_at",                                             null: false
    t.boolean  "show_new_collection",                    default: true
    t.boolean  "show_testimonial",                       default: true
    t.string   "logo_file_name",           limit: 255
    t.string   "logo_content_type",        limit: 255
    t.integer  "logo_file_size",           limit: 4
    t.datetime "logo_updated_at"
    t.string   "instagram_client_id",      limit: 255
    t.string   "footer_logo_file_name",    limit: 255
    t.string   "footer_logo_content_type", limit: 255
    t.integer  "footer_logo_file_size",    limit: 4
  ...
  create_table "spree_tax_cloud_cart_items", force: :cascade do |t|
    ...
    t.integer  "line_item_id",             limit: 4
    t.integer  "tax_cloud_transaction_id", limit: 4
    t.string   "type",                     limit: 255
    t.datetime "created_at",                                                                  null: false
    t.datetime "updated_at",                                                                  null: false
  end
  ...
  create_table "spree_taxons", force: :cascade do |t|
    ...
    t.datetime "banner_updated_at"
    t.integer  "ls_id",                    limit: 4
    t.integer  "ls_parent_id",             limit: 4
    t.string   "extenal_link",             limit: 255
  end
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.string   "ls_name",              limit: 255
    t.integer  "ls_id",                limit: 4
    t.integer  "ls_matrix_id",         limit: 4
    t.boolean  "enabled",                                                          default: true
    t.decimal  "ls_msrp",                                 precision: 8,  scale: 2
    t.decimal  "ls_length",                               precision: 8,  scale: 2
    t.string   "ls_upc",               limit: 255
    t.string   "ls_custom_sku",        limit: 255
    t.string   "ls_manufacturer_sku",  limit: 255
    t.decimal  "ls_default_cost",                         precision: 8,  scale: 2
    t.text     "ls_long_description",  limit: 4294967295
    t.text     "ls_short_description", limit: 4294967295
    t.integer  "local_merchant_id",    limit: 4
    t.string   "local_merchant_key",   limit: 255
    t.string   "shipping_speed",       limit: 255
