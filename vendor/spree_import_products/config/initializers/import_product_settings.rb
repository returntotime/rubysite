...
IMPORT_PRODUCT_SETTINGS = {
  ...
  :product_image_path => "#{Rails.root}/lib/etc/product_data/product-images/",  #"/home/aswathi/Downloads/",  #{}"#{Rails.root}/lib/etc/product_data/product-images/", #The location of images on disk
