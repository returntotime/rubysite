Spree::Core::Engine.routes.draw do
  namespace :admin do
    ...
    post '/blog_categories/update_featured'
    resources :blog_categories, :only => [:edit, :update, :index, :destroy]

    # resources :toto, :controller=>"blog_categories"
  end
  ...
  scope Spree::Config['blog_alias'], as: 'blog' do
    ...
    get '/search' => 'blog_entries#search'
  end
end
